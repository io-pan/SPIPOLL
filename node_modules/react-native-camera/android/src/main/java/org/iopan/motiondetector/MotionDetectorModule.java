...
private static ReactApplicationContext mScopedContext;
  ...
  public Map<String, Object> getConstants() {
    return Collections.unmodifiableMap(new HashMap<String, Object>() {
      ...
      //   return Collections.unmodifiableMap(new HashMap<String, Object>() {
      //     {
      //       put("all", MotionDetector.ALL_CLASSIFICATIONS);
      //       put("none", MotionDetector.NO_CLASSIFICATIONS);
      //     }
      //   });
      // }
      ...
      //   return Collections.unmodifiableMap(new HashMap<String, Object>() {
      //     {
      //       put("all", MotionDetector.ALL_LANDMARKS);
      //       put("none", MotionDetector.NO_LANDMARKS);
      //     }
      //   });
      // }
    });
