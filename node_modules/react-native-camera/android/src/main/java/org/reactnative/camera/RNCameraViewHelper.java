...
public class RNCameraViewHelper {
  ...
  public static void emitMotionDetectionErrorEvent(ViewGroup view, MotionDetector faceDetector) {
    MotionDetectionErrorEvent event = MotionDetectionErrorEvent.obtain(view.getId(), faceDetector);
    ReactContext reactContext = (ReactContext) view.getContext();
    reactContext.getNativeModule(UIManagerModule.class).getEventDispatcher().dispatchEvent(event);
  }
