...
public class RNCameraView extends CameraView implements LifecycleEventListener, BarCodeScannerAsyncTaskDelegate, FaceDetectorAsyncTaskDelegate,
  ...
  private int mMotionDetectionLandmarks = 0;// MotionDetector.NO_LANDMARKS;
   ...
   */
  public void onMotionDetected(SparseArray<WritableMap> motionReported, int sourceWidth, int sourceHeight, int sourceRotation) {
    if (!mShouldDetectMotion) {
      return;
    }

    SparseArray<WritableMap> motionDetected = motionReported == null ? new SparseArray<WritableMap>() : motionReported;
