...
public class RNCameraView extends CameraView implements LifecycleEventListener, BarCodeScannerAsyncTaskDelegate, FaceDetectorAsyncTaskDelegate,
    MotionDetectorAsyncTaskDelegate,
...
private int mMotionDetectorMode = 1;//MotionDetector.FAST_MODE;
  ...
  public RNCameraView(ThemedReactContext themedReactContext) {
    ...
    if (willCallMotionTask) {
      ...
      new MotionDetectorAsyncTask(delegate, mMotionDetector, data, width, height, correctRotation).execute();
    }
...
private void setupMotionDetector() {
  ...
  // mMotionDetector.setLandmarkType(mMotionDetectionLandmarks);
  // mMotionDetector.setClassificationType(mMotionDetectionClassifications);
  mMotionDetector.setTracking(true);
}

// public void setMotionDetectionLandmarks(int landmarks) {
//   mMotionDetectionLandmarks = landmarks;
//   if (mMotionDetector != null) {
//     mMotionDetector.setLandmarkType(landmarks);
//   }
// }

// public void setMotionDetectionClassifications(int classifications) {
//   mMotionDetectionClassifications = classifications;
//   if (mMotionDetector != null) {
//     mMotionDetector.setClassificationType(classifications);
//   }
// }
 ...
 */
public void onMotionDetected(SparseArray<WritableMap> facesReported, int sourceWidth, int sourceHeight, int sourceRotation) {
  if (!mShouldDetectMotion) {
    return;
  }

  SparseArray<WritableMap> facesDetected = facesReported == null ? new SparseArray<WritableMap>() : facesReported;

  ImageDimensions dimensions = new ImageDimensions(sourceWidth, sourceHeight, sourceRotation, getFacing());
  RNCameraViewHelper.emitMotionDetectedEvent(this, facesDetected, dimensions);
}
