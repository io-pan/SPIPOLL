...
console.log('pan', this._pan);
      ...
      // if(angleChange){
        // const rad = (parseFloat(this._angle) + angleChange) * Math.PI / 180;
        //       dx =    currentCenter.x - this._pan.x,
        //       dy =   currentCenter.y - this._pan.y ;
  ...
  render() {
    ...
    // if (rotate) {
    //  animatedStyle.transform.push({ rotate: this.state.angle._value + 'deg' });
    // }
    return (
      <View
        style={[
